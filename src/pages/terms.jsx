          ...
          <div className="relative">
            <div className="relative z-10 pt-5 pb-20">
              <div className="pt-10 max-w-[42rem] px-5 text-gray-200 font-Hublot">
                <h1 className="font-Mona text-4xl mb-8 text-white font-bold">
                ...
                <p className="leading-relaxed mb-4">
                  ...
                  the Geogit web application operated by Geogit.
                </p>
                ...
                <p className="leading-relaxed mb-4">
                  The Service allows you to search and view profiles of software
                  developers based on location, sourced from GitHub, GitLab, and
                  BitBucket. We make no guarantee regarding the accuracy,
                  completeness, or timeliness of the data presented, as it is
                  based on user-provided information and third-party APIs. The
                ...
                <p className="leading-relaxed mb-4">
                  ...
                  and will remain the exclusive property of Geogit and its
                  licensors. The Service is protected by copyright, trademark,
                  and other laws of both the Ireland and foreign countries.
                </p>
                ...
                <p className="leading-relaxed mb-4">
                  In no event shall Geogit, nor its directors, employees,
                  partners, agents, suppliers, or affiliates, be liable for any
                  indirect, incidental, special, consequential or punitive
                  damages, including without limitation, loss of profits, data,
                  use, goodwill, or other intangible losses, resulting from (i)
                  your access to or use of or inability to access or use the
                  Service; (ii) any unauthorized access to or use of our servers
                ...
                <p className="leading-relaxed mb-4">
                  ...
                  the laws of the Republic of Ireland, without regard to its
