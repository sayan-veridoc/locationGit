          ...
          {Object.keys(languages).length === 0 ? (
            ...
            Object.entries(languages).map(([language]) => (
              <li key={language} className="flex items-center mb-1.5">
                <span
                  className={`language-color-dot ${getLanguageClassName(language)} White`}
                ></span>
                {language}
              </li>
            ))
                        ...
                        <DialogHeader className="flex items-left  text-white">
                          <div className="">
                            ...
                            <div className="flex justify-left pt-2  items-center">
                              {user.name && (
                                <div className="">
                                  <span className="font-bold text-xl font-Mona max-w-xl  ">
                                    {user.name}
                                  </span>
                                </div>
                              )}
                              ...
                              <div className="flex items-center">
                                <div className="text-gray-300 max-w-[10rem] sm:max-w-[19rem] text-xl truncate">
                                  {user.location}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="pt-2 pb-2 text-md text-left justify-left">
                              <span className="text-left font-Hublot break-words overflow-hidden max-w-[10rem] sm:max-w-full">
                                {user.bio || " "}
                              </span>
                            </div>
                          </div>
                              ...
                              <div className="flex-grow">
                                <ul>
                                  <li className="flex items-center mb-2">
                                    ...
                                    <div className="text-gray-300 max-w-[10rem] sm:max-w-[15rem] truncate">
                                  ...
                                  <li className="flex items-center mb-2">
                                    ...
                                    <div className="text-gray-300">
                                      {" "}
                                      {numeral(user.followers).format("0.[0]a")}
                                    </div>
                                  </li>
      ...
      {!dataLoaded ? (
        ...
        page < 10 && (
          <button
            ...
            className="font-mono select-none show-more-button mx-auto block"
          >
            Show More
          </button>
        )
